...
namespace MauticPlugin\MauticDeskBundle\EventListener;
...
class FormSubscriber extends CommonSubscriber
{
    ...
    public function onFormBuild (FormBuilderEvent $event)
    {
        $action = array(
            ...
            'label'       => 'mautic.plugin.actions.form_to_desk',
            'formType'    => 'formfields_list',
            'callback'    => array('\\MauticPlugin\\MauticDeskBundle\\Integration\\DeskIntegration', 'pushForm')
        );
